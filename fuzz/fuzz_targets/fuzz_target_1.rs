...
mod mock {
    ...
    use {
        ...
        num_traits::Num,
        pallet_pooled_staking::{
            candidate::Candidates, pools::Pool, Candidate, Delegator, PendingOperationKey,
    ...
    impl<T: pallet_pooled_staking::Config> PoolExt<T>
        for pallet_pooled_staking::pools::ManualRewards<T>
    {
        fn target_pool() -> TargetPool {
    ...
    impl<T: pallet_pooled_staking::Config> PoolExt<T>
        for pallet_pooled_staking::pools::AutoCompounding<T>
    {
        fn target_pool() -> TargetPool {
